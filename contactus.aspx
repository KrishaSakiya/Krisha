<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MasterPage1.master" AutoEventWireup="true" CodeFile="contactus.aspx.cs" Inherits="admin_contactus" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <div class="gv">
            ...
            <asp:GridView runat="server" ID="GridView1" PageSize="10"  HorizontalAlign="Center"
                ...
                <asp:BoundField HeaderText="Message" DataField="message" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle"/>
